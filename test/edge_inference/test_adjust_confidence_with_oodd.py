...
def test_adjust_confidence_with_oodd_binary(mock_parsed_binary_response, mock_outlier_oodd_response, mock_inlier_oodd_response):
    num_classes = 2
...
def test_adjust_confidence_with_oodd_count(mock_parsed_count_response, mock_outlier_oodd_response, mock_inlier_oodd_response):
    num_classes = 4
    adjusted_output_dict = adjust_confidence_with_oodd(
    ...
    assert adjusted_output_dict["rois"][0]["geometry"] == {"x":  0.2, "y": 0.3, "left": 0.1, "top": 0.2, "right": 0.3, "bottom": 0.4}
