...
api_router = APIRouter(dependencies=[Depends(require_valid_token)])
...
edge_config_router = APIRouter(dependencies=[Depends(require_valid_token)])
...
edge_detector_readiness_router = APIRouter(dependencies=[Depends(require_valid_token)])
