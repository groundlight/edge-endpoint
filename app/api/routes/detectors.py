...
def create_detector(props: DetectorCreate, gl: Depends = Depends(get_groundlight_sdk_instance)):
...
def get_detector(id: str, gl: Depends = Depends(get_groundlight_sdk_instance)):
