...
function Option({
  ...
  if (!isOptionsGroup.isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && (checked ? /* @__PURE__ */ jsxRuntime.jsx(CheckIcon.CheckIcon, { className: Combobox_module.optionsDropdownCheckIcon }) : withAlignedLabels ? /* @__PURE__ */ jsxRuntime.jsx("div", { className: Combobox_module.optionsDropdownCheckPlaceholder }) : null);
