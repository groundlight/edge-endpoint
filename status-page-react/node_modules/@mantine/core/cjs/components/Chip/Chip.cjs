      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          "label",
          {
            ...
            children: [
              _checked && icon !== null && icon !== false && /* @__PURE__ */ jsxRuntime.jsx("span", { ...getStyles("iconWrapper"), children: icon === void 0 ? /* @__PURE__ */ jsxRuntime.jsx(CheckIcon.CheckIcon, { ...getStyles("checkIcon") }) : icon }),
