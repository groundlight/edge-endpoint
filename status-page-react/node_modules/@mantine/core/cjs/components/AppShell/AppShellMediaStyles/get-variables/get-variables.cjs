...
function getVariables({
  ...
  assignHeaderVariables.assignHeaderVariables({ baseStyles, minMediaStyles, header, mode });
  assignFooterVariables.assignFooterVariables({ baseStyles, minMediaStyles, footer, mode });
