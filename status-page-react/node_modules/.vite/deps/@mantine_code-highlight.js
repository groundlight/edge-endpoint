...
// node_modules/@mantine/code-highlight/esm/CodeHighlight.module.css.mjs
var classes = { "root": "m_5cb1b9c8", "codeHighlight": "m_e597c321", "inlineCodeHighlight": "m_dfe9c588", "pre": "m_2c47c4fd", "code": "m_5caae6d3", "controls": "m_be7e9c9c", "control": "m_d498bab7", "controlTooltip": "m_4c3d814c", "scrollarea": "m_f744fd40", "showCodeButton": "m_c9378bc2", "file": "m_5cac2e62", "fileIcon": "m_b46cddfb", "filesScrollarea": "m_7b14120b", "files": "m_38d99e51" };
...
var plainTextAdapter = {
  getHighlighter: () => ({ code }) => ({ highlightedCode: code, isHighlighted: false })
};

// node_modules/@mantine/code-highlight/esm/CodeHighlightProvider/CodeHighlightProvider.mjs
var [CodeHighlightProvider, useCodeHighlight] = createOptionalContext({
...
function CodeHighlightAdapterProvider({
  ...
  const highlight = (0, import_react.useMemo)(() => adapter.getHighlighter(ctx), [adapter, ctx]);
  (0, import_react.useEffect)(() => {
    if (adapter.loadContext) {
      adapter.loadContext().then(setCtx);
    }
  }, [adapter]);
  return (0, import_jsx_runtime.jsx)(CodeHighlightProvider, { value: { adapter, highlight }, children });
}
function useHighlight() {
  const ctx = useCodeHighlight();
  return (ctx == null ? void 0 : ctx.highlight) || plainTextAdapter.getHighlighter(null);
}

// node_modules/@mantine/code-highlight/esm/CodeHighlight/CodeHighlight.context.mjs
var [CodeHighlightContextProvider, useCodeHighlightContext] = createSafeContext(
...
var CodeHighlightControl = polymorphicFactory((_props, ref) => {
  ...
  const control = (0, import_jsx_runtime2.jsx)(
    ActionIcon,
    {
      ref,
...
function CopyIcon({ copied, ...others }) {
  return (0, import_jsx_runtime3.jsx)(
    "svg",
    {
      ...
      ...others,
      children: copied ? (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        (0, import_jsx_runtime3.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime3.jsx)("path", { d: "M5 12l5 5l10 -10" })
      ] }) : (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        (0, import_jsx_runtime3.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime3.jsx)("path", { d: "M8 8m0 2a2 2 0 0 1 2 -2h8a2 2 0 0 1 2 2v8a2 2 0 0 1 -2 2h-8a2 2 0 0 1 -2 -2z" }),
        (0, import_jsx_runtime3.jsx)("path", { d: "M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2" })
      ] })
    }
  );
}
...
function CopyCodeButton({
  ...
  return (0, import_jsx_runtime4.jsx)(
    CodeHighlightControl,
    {
      ...
      children: (0, import_jsx_runtime4.jsx)(CopyIcon, { copied: clipboard.copied })
    }
  );
}
...
function ExpandIcon({ expanded, style, ...others }) {
  return (0, import_jsx_runtime5.jsx)(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      ...others,
      children: expanded ? (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
        (0, import_jsx_runtime5.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M12 13v-8l-3 3m6 0l-3 -3" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M9 17l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M14 17l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M19 17l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M4 17l1 0" })
      ] }) : (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
        (0, import_jsx_runtime5.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M12 11v8l3 -3m-6 0l3 3" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M9 7l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M14 7l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M19 7l1 0" }),
        (0, import_jsx_runtime5.jsx)("path", { d: "M4 7l1 0" })
      ] })
    }
  );
}
...
function ExpandCodeButton({
  ...
  return (0, import_jsx_runtime6.jsx)(
    CodeHighlightControl,
    {
      ...
      children: (0, import_jsx_runtime6.jsx)(ExpandIcon, { expanded })
    }
  );
}
...
var CodeHighlight = factory((_props, ref) => {
  var _a, _b, _c, _d;
    ...
    return (0, import_jsx_runtime7.jsx)(
      Box,
      {
        ...
        ...getStyles("codeHighlight", {
          className: clsx_default((_a = highlightedCode.codeElementProps) == null ? void 0 : _a.className, className),
          style: [{ ...(_b = highlightedCode.codeElementProps) == null ? void 0 : _b.style }, style]
        }),
  ...
  return (0, import_jsx_runtime7.jsx)(CodeHighlightContextProvider, { value: { getStyles, codeColorScheme }, children: (0, import_jsx_runtime7.jsxs)(
    Box,
    {
      ref,
      ...getStyles("codeHighlight"),
      ...
      "data-with-border": withBorder || void 0,
      children: [
        shouldDisplayControls && (0, import_jsx_runtime7.jsxs)("div", { ...getStyles("controls"), "data-with-offset": __withOffset || void 0, children: [
          controls,
          withExpandButton && (0, import_jsx_runtime7.jsx)(
            ExpandCodeButton,
            {
              expanded: _expanded,
          ...
          withCopyButton && (0, import_jsx_runtime7.jsx)(CopyCodeButton, { code, copiedLabel, copyLabel })
        ] }),
        (0, import_jsx_runtime7.jsx)(
          ScrollArea,
          {
            ...
            children: (0, import_jsx_runtime7.jsx)("pre", { ...getStyles("pre"), "data-with-offset": __withOffset || void 0, children: (0, import_jsx_runtime7.jsx)(
              "code",
              {
                ...highlightedCode.codeElementProps,
                ...getStyles("code", {
                  className: (_c = highlightedCode.codeElementProps) == null ? void 0 : _c.className,
                  style: (_d = highlightedCode.codeElementProps) == null ? void 0 : _d.style
                }),
                ...codeContent
              }
            ) })
...
var InlineCodeHighlight = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime8.jsx)(CodeHighlight, { ...others, ref, ...getStyles("inlineCodeHighlight"), __inline: true });
});
...
function FileIcon({ fileIcon, fileName, getFileIcon, className, style }) {
  if (fileIcon) {
    return (0, import_jsx_runtime9.jsx)("span", { className, style, children: fileIcon });
  }
  if (getFileIcon && fileName) {
    return (0, import_jsx_runtime9.jsx)("span", { className, style, children: getFileIcon(fileName) });
  }
  return null;
}

// node_modules/@mantine/code-highlight/esm/CodeHighlightTabs/CodeHighlightTabs.mjs
var CodeHighlightTabs = factory((_props, ref) => {
  ...
  const currentCode = code[value] || { code: "", language: "tsx" };
  const files = code.map((node, index) => (0, import_react2.createElement)(
    UnstyledButton,
    {
      ...getStyles("file"),
      key: node.fileName,
    ...
    (0, import_jsx_runtime10.jsx)("span", { children: node.fileName }, "file-name")
  ));
  return (0, import_jsx_runtime10.jsxs)(Box, { ref, ...getStyles("root"), ...others, children: [
    (0, import_jsx_runtime10.jsx)(ScrollArea, { type: "never", dir: "ltr", offsetScrollbars: false, ...getStyles("filesScrollarea"), children: (0, import_jsx_runtime10.jsx)("div", { ...getStyles("files"), children: files }) }),
    (0, import_jsx_runtime10.jsx)(
      CodeHighlight,
      {
...
//# sourceMappingURL=@mantine_code-highlight.js.map
